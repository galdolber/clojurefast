...
;; TODO test ~:^ works in ~@:{...~}
#_(let [aseq '(a quick brown fox jumped over the lazy dog)
...
#_(let [donestr "Done.~^  ~D warning~:P.~^  ~D error~:P."
